...
const Navbar = () => {
  ...
  return (
    <div className="fixed w-full h-[80px] flex justify-between items-center px-4 bg-[#212121] text-white">
      <div>
        <img src={resume1} alt="resume1" style={{ width: '60px' }} />
      </div>
      ...
      <div className="hidden lg:flex fixed flex-col top-[35%] left-0">
        <ul>
          ...
          <li className="w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-[#277BC0]">
            <a
              className="flex justify-between items-center w-full text-gray-300"
          ...
          <li className="w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-[#252A34]">
            <a
              className="flex justify-between items-center w-full text-gray-300"
